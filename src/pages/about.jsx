  ...
  return (
    <div className="page">
      ...
      <ul>
        ...
        <li>🌈 Use the <strong>Share</strong> button in the Glitch editor to invite others in to edit your new React project by typing in their email address or Glitch username. <br />( <strong>Tip:</strong> 👀Make your code, or even your entire app, private to just those you invite, just by <a href="https://glitch.com/pricing">upgrading your Glitch account</a>.)</li>
      </ul>
      
      <p> The Glitch community is glad to welcome you, and the Internet is better when it's made by real people. We can't wait to see what you create!</p>
      <p>
